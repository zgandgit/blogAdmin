<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\blogAdmin\public/../application/admin\view\article\course_list.html";i:1551700685;s:65:"D:\phpStudy\WWW\blogAdmin\application\admin\view\public\base.html";i:1551700685;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <a href="<?php echo url('Article/addCourse'); ?>"> <button type="button" class="btn btn-gradient-success btn-fw">添加教程</button></a>
            <table class="table table-striped">
                ...
                <tr id="del<?php echo $vo['id']; ?>">
                    <td class="py-1">
                        <img src="<?php echo $vo['cove_url']; ?>" class="mw-100 w-auto h-auto rounded" alt="image">
                    </td>
                    <td>
                        <?php echo $vo['title']; ?>
                    </td>
                    ...
                    <th>
                        <a href="<?php echo url('Article/addCourse',['id'=>$vo['id']]); ?>">
                            <button type="button" class="btn btn-gradient-success btn-sm">修改</button>
                        </a>
                        <a href="<?php echo url('Article/updateCourseArticle',['id'=>$vo['id']]); ?>">
                        <button type="button" class="btn btn-gradient-success btn-sm">更新教程</button>
                        </a>
...
<script>
    function remove(e) {
        if(confirm("您确定要删除吗?将会删除所有文档下面的教程")){
            let data = {};
            data.id = e;
            ajaxRemoveCourse(data);
            return false;
        }
