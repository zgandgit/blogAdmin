<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpStudy\WWW\blogAdmin\public/../application/admin\view\article\index.html";i:1551700685;s:65:"D:\phpStudy\WWW\blogAdmin\application\admin\view\public\base.html";i:1551700685;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="form-inline" action="<?php echo url('Article/index'); ?>">
                <div class="input-group mb-2 mr-sm-2">
                <a href="<?php echo url('Article/addArticle'); ?>"> <button type="button" class="btn btn-gradient-success btn-fw">添加文章</button></a>
                </div>
                ...
                <div class="input-group mb-2 mr-sm-2">
                    <select class="form-control" name="fid">
                        ...
                        <?php if(is_array($flList) || $flList instanceof \think\Collection || $flList instanceof \think\Paginator): $i = 0; $__LIST__ = $flList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <table class="table table-striped">
                ...
                <tr id="del<?php echo $vo['id']; ?>">
                    ...
                    <td>
                        <img src="<?php echo $vo['cove_url']; ?>" alt="">
                    ...
                    <th>
                        <a href="<?php echo url('Article/addArticle',['id'=>$vo['id']]); ?>">
